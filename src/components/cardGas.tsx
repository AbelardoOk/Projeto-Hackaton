...
<br></br>
                        ...
                        <b>Características: </b>
                        O gás natural é um combustível de origem fóssil composto por uma mistura de hidrocarbonetos como o metano e o etano. Ele é encontrado em depósitos subterrâneos comumente associados ao petróleo, mas pode ocorrer também de maneira isolada. <br></br>
<br></br>
                       <b>Vantagens:</b>
                        Uma de suas principais vantagens é o fato de ele emitir menos gases poluentes na atmosfera do que os derivados de petróleo e não gerar outros tipos de resíduos. <br></br>
<br></br>
                        <b>Desvantagens</b>:
